...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -3385.0060830496345; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3119.8201836196663; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 107.28266988875792; // x position of the perpendicular encoder (in tick units)
    }
