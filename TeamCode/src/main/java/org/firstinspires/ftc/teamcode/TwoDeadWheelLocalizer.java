...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3393.095211345963; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 125.11626561244468; // x position of the perpendicular encoder (in tick units)
    }
